...
function EmailField({
  ...
  return (
    <>
      <div className="mb-3">
        <input
          className={`mb-1 appearance-none rounded border w-full py-2 px-3 text-black placeholder:text-black/50 leading-tight focus:shadow-outline ${
      ...
      <div className="flex items-center justify-between">
        <button
          className="bg-emerald-600 rounded text-slate-50 py-2 px-4 focus:shadow-outline block w-full"
          type="submit"
        >
          Next
        </button>
...
function PasswordField({
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between">
        <button
          className="bg-emerald-600 text-contrast rounded py-2 px-4 focus:shadow-outline block w-full"
          type="submit"
        >
          Sign in
        </button>
