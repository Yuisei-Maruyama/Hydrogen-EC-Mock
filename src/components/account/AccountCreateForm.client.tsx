    ...
    <div className="flex justify-center my-24 px-4">
      <div className="max-w-md w-full">
        ...
        <form noValidate className="pt-6 pb-8 mt-4 mb-4" onSubmit={onSubmit}>
          ...
          <div className="mb-3">
            <input
              className={`mb-1 appearance-none rounded border w-full py-2 px-3 text-black/90 placeholder:text-black/50 leading-tight focus:shadow-outline ${
          ...
          <div className="flex items-center justify-between">
            <button
              className="bg-emerald-600 text-white rounded py-2 px-4 focus:shadow-outline block w-full"
              type="submit"
            >
              Create Account
            </button>
